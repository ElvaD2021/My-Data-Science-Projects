...
<Write here what the goal of this analysis is. What question are we trying to answer?> Cleaning the data, naming columns accordingly, specifying the kind of class object it is: in addition, we investigated any potential relationship between the number of readers for a book and the suggested price. We plotted these data in the form of a scatterplot for visuals.
...
- What did we find out about our questions? Needed to needed to understand the reason and significance of P value
- How did we explore our questions? Asking questions concerning the reasoning and why the P value matter.
- What did our explorations show us? During our class,depending on each participant data outcome, each p value was different
